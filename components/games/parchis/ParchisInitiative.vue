...
<template>
  <div class="fixed inset-0 z-[100] flex items-center justify-center p-4 initiative-overlay bg-[#1a0f0a]/80 backdrop-blur-2xl opacity-0">
    ...
    >
      <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-1/2 bg-amber-500/10 blur-[100px] pointer-events-none rounded-full"/>
      <div class="absolute bottom-0 right-0 w-64 h-64 bg-orange-500/10 blur-[100px] pointer-events-none rounded-full"/>
      <div class="absolute top-0 right-0 w-[500px] h-[2px] bg-gradient-to-r from-transparent via-amber-500/50 to-transparent"/>
      ...
      <div class="roll-action opacity-0 relative z-10 w-full flex justify-center mt-4">
        ...
        >
          <div class="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-400/20 to-amber-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"/>
          <div class="absolute inset-0 bg-white/10 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out"/>
          ...
          <div class="absolute -inset-1 bg-amber-500/30 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl -z-10"/>
        </button>
        ...
        <div v-else class="px-10 py-5 bg-orange-900/20 border border-orange-500/20 backdrop-blur-md rounded-2xl flex flex-col items-center shadow-[inset_0_0_20px_rgba(249,115,22,0.1)] relative">
          <div class="absolute top-0 w-1/2 h-[1px] bg-gradient-to-r from-transparent via-orange-500/50 to-transparent"/>
