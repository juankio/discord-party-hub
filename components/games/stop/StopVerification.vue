<template>
  <div class="h-full w-full flex-1 p-4 sm:p-8 relative flex flex-col items-center overflow-y-auto overscroll-contain" style="color: var(--theme-text-color, white);">
