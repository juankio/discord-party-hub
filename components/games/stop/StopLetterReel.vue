<template>
  <div class="relative flex flex-col items-center group">
    ...
    <div class="w-24 h-24 sm:w-28 sm:h-28 bg-[#4a2e1b] rounded-2xl border-8 border-[#2a180c] shadow-[inset_0_0_20px_rgba(0,0,0,0.8),0_10px_20px_rgba(0,0,0,0.5)] flex items-center justify-center overflow-hidden relative">
      <div class="absolute inset-0 opacity-20 pointer-events-none mix-blend-overlay" style="background-image: repeating-linear-gradient(45deg, transparent, transparent 10px, #000 10px, #000 20px);"/>
      <div class="absolute inset-2 bg-[#1a0f08] rounded-xl shadow-inner border-2 border-[#150a05]"/>
      ...
      <!-- Shaders/Highlights -->
      <div class="absolute top-1 left-2 right-2 h-3 bg-white/10 rounded-full blur-[2px] z-20 pointer-events-none"/>
    </div>
  </div>
</template>
