<template>
  <div class="flex-1 flex justify-center items-end relative z-10 w-full pt-12 pb-2 md:pt-16 md:pb-6">
    <div class="relative mx-auto w-[calc(100vw-2rem)] sm:w-[calc(100vw-8rem)] md:w-full max-w-[900px] lg:max-w-[1000px] aspect-[2/1] sm:aspect-[2.2/1] max-h-[350px] sm:max-h-[420px]">
