...
<template>
  <div class="h-[100dvh] w-full overflow-hidden flex flex-col relative" :class="bgClass || 'bg-zinc-950'">
    ...
    <div v-if="rules && rules.length > 0" 
      ...
      >
        ...
        <ul class="space-y-2.5 text-[#5c3a21] font-medium text-sm md:text-base max-h-[60vh] overflow-y-auto custom-scrollbar-notebook pb-2 pr-1">
