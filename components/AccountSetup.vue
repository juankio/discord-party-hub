<template>
  <div class="flex flex-col items-center gap-4 w-full relative">
    ...
    <div v-else class="w-full flex flex-col gap-6 mt-4">
      ...
      <a href="/api/auth/google/login" class="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-200 text-black px-6 py-4 rounded-full font-black transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.2)] decoration-none">
