  ...
  <div class="min-h-screen overflow-hidden">
    ...
    >
      <div class="w-full max-w-[380px] mx-auto bg-[#151515] p-6 rounded-3xl shadow-2xl flex flex-col items-center gap-6 border border-white/5">
        ...
        <!-- Botón Google -->
        <a :href="config.public.socketUrl + '/api/auth/google/login'" class="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-200 text-black px-6 py-3.5 rounded-full font-black transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.2)] decoration-none">
